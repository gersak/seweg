...
;; TODO Sometimes there is no evaluation for unknown reason.
;; It manifests only for some OIDs, but I know that reason is
;; becouse this function doesn't evaluate. If println is inserted
;; than everythig works fine. ODD!!!!!
