...
(comment
  ...
  (def all-addresses  (read-string  (slurp "/home/rgersak/Krakken/all-addresses.edn")))
  ...
  (defn discover-hosts
    ...
    (let [poke-oids [[1 3 6 1 2 1 1 2 0] [1 3 6 1 2 1 1 5 0] [1 3 6 1 2 1 1 6 0] [1 3 6 1 2 1 47 1 1 1 1 11 1] [1 3 6 1 2 1 1 3 0]]
          hosts-data (shout all-addresses :community community :oids poke-oids :timeout timeout :send-interval 2)
          pretty-data (fn [x]
                        (let [vb (:bindings x)
